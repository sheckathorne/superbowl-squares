...
let results = [];
const sections = document.querySelectorAll("section .d3-l-grid--outer.d3-l-section-row .d3-l-grid--inner");
for (let i = 0; i < sections.length; i++) {
    const teams = sections[i].querySelectorAll("div.d3-l-col__col-12:not(#scroll-nfcteams):not(#scroll-afcteams)");
